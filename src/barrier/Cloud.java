 ...
 * @author asdfg
 */
public class Cloud extends MovingBarrier{
    
    public Cloud(int x, int y,int speedX, int distanceGridX,int speedY, int distanceGridY) {
        super(x, y, Global.GRID_SIZE_X, Global.GRID_SIZE_Y, 0, 0, 20, 30);
        ImageResourceController irc = ImageResourceController.getInstance();
        img = irc.tryGetImage(PathBuilder.getImage(ImagePath.Barrier.CLOUD));
        setSpeedX(speedX);
